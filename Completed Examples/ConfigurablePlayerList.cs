...
{
    public class ConfigurablePlayerList : PRoConPluginAPI, IPRoConPluginInterface
    {
        private bool pluginEnabled = false;
        private List<String> customPlayerList = new List<String>();
        private int debugLevel = 1;

        public ConfigurablePlayerList()
        {
        ...
        {
            return @"This example shows you how to create a configurable string array within PRoCon, specifically for player names. Elements are sorted alphabetically and automatically removed when their fields are cleared.";
        }
        ...
        public void OnPluginEnable()
        {
            ...
            this.toConsole(1, "ConfigurablePlayerList Enabled!");
        }

        public void OnPluginDisable()
        {
            this.pluginEnabled = false;
            this.toConsole(1, "ConfigurablePlayerList Disabled!");
        }

        public List<CPluginVariable> GetDisplayPluginVariables()
        {
            List<CPluginVariable> lstReturn = new List<CPluginVariable>();
            lstReturn.Add(new CPluginVariable("Playerlist|Add a soldier name... (ci)", typeof(string), ""));
            ...
            for (int i = 0; i < customPlayerList.Count; i++ )
            {
                ...
                {
                    lstReturn.Add(new CPluginVariable("Playerlist|" + i.ToString() + ". Soldier name:", typeof(string), thisPlayer));
                }
            }
